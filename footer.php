<footer>
  ...
  <?php }?>
	<div>
		...
		<p><span class="alignright"><?php wp_register('','');?></span><?php printf('Copyright &copy; 2006-2011 <a href="%1$s/" title="%2$s" rel="home">%2$s</a> &brvbar; Powered by <a href="http://wordpress.org/">WordPress</a>.',ilost_wp_homeurl,ilost_wp_name);?>
    </p>
	</div>
</footer>
<?php wp_footer();?>
